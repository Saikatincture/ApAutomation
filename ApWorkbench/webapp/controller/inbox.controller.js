sap.ui.define([
	...
	return BaseController.extend("com.inc.ApWorkbench.controller.inbox", {
		onInit: function () {
			...
			this.oRouter.attachRoutePatternMatched(function (oEvent) {
				if (oEvent.getParameters().arguments.value && (oEvent.getParameters().arguments.value == "INVOICE" || oEvent.getParameters().arguments
					...
					that.onGo();
				} else if ((taskDataFilterModel.getProperty("/invoiceType") === "INVOICE") || (taskDataFilterModel.getProperty("/invoiceType") ===
						"NONPO")) {
					that.onGo();
		...
		onSelectIconTabBar: function (oEvent) {
			...
			/*	if (selectedKey === "opentask") {
						
				} else if (selectedKey === "mytask") {
