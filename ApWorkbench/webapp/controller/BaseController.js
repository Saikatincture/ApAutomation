sap.ui.define([
	...
	"use strict";
	return Controller.extend("com.inc.ApWorkbench.controller.BaseController", {
		/**
		...
		/*To handle the application session*/
		handleSession: function () {
			setInterval(function () {
				jQuery.ajax({
					type: "HEAD",
					cache: false,
					url: "/ApWorkbench/Component.js"
				}).done(
					function (result) {
					...
					function () {
						...
						MessageBox.warning("Session Timeout, please reload the app", {
							actions: ["Reload"],
		...
		_getFormFragment: function (sFragmentName) {
			...
			oFormFragment = sap.ui.xmlfragment(this.getView().getId(), "com.inc.ApWorkbench.view.fragments." + sFragmentName, this);
