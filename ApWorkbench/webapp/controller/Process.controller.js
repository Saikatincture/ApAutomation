sap.ui.define([
	...
	return Controller.extend("com.inc.ApWorkbench.controller.Process", {
		onInit: function () {
			var obj = {
				invNo: "",
				InvoiceDate: null,
		...
		onPressNextProcessInvoice: function () {
			...
			if (itemIndex !== -1) {
				if (!this.createMemoFrag) {
					...
					this.createMemoFrag = sap.ui.xmlfragment("com.inc.ApWorkbench.view.Fragments.createMemoFrag", this);
