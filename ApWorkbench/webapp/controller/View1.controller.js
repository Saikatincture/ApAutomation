sap.ui.define([
	...
	return Controller.extend("com.inc.ApWorkbench.controller.View1", {
		onInit: function () {
			...
			// console.log(oRoles);
			var graphModel = new sap.ui.model.json.JSONModel("model/chart.json");
			...
			this.table = sap.ui.xmlfragment("com.inc.ApWorkbench.view.fragments.inboxTable", this);
